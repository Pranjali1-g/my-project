...
| POST   | `/cards`     | Add a new card                                | `{ "suit": "Spades", "value": "Ace" }`        | `{"id":2,"suit":"Spades","value":"K"}`    |
| PUT    | `/cards/:id` | Update an entire card (replace suit & value)  | `{ "suit": "Diamonds", "value": "8" }`     | `{"id":2,"suit":"Diamonds","value":"10"}` |
...
### Outputs
### GET All Cards 
![GET](./images/Allcards.png)

### GET a Card
![GET](./images/Getcard1.png)

### POST Cards
![POST](./images/Postcards.png)

### PUT Card
![PUT](./images/Putcard1.png)

### DELETE a Card
![DELETE](./images/Deletecard2.png)
