...
```json
{
  "message": "Seat 2 locked successfully. Confirm within 60 seconds."
}
```
...
```json
{
  "message": "Seat 2 booked successfully!"
}
```
...
## 🎟️ Seat Booking Screenshots

### All Seats 
This screen shows all available seats before any booking.
![All Seats](./images/AllSeats.png)

### Locking a Seat
This screen shows the seat locking process.
![Lock Seat](./images/LockSeat2.png)

### Confirming a Seat
This screen shows confirming a booked seat.
![Confirm Seat](./images/ConfirmSeat2.png)

### Postman Steps of performing this Experiment
This shows the API requests and responses in Postman.
